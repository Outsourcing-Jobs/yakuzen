...
const recentWorks = [
  {
    ...
    tag: "ILLUSTRATION",
    imgUrl:
      "https://framerusercontent.com/images/aPzYEPAdRz1sF28869k0vyLBts.jpg?width=700&height=943",
  },
  {
    id: 2,
    title: "Chain Break",
    tag: "MODEL ART",
    imgUrl:
      "https://framerusercontent.com/images/B5ltLWWMNvIgAzAesNvBfvwe69Y.jpg?width=700&height=943",
  },
  {
    id: 3,
    title: "Spike & Shade",
  ...
  },
  {
    ...
    tag: "MODEL ART",
    imgUrl:
      "https://framerusercontent.com/images/nBO5THno7iF7y7SsHfiRhBfzBY.jpg?width=700&height=943",
  },
];
      ...
      <section className="hp-hero">
        <div className="hp-hero__left">
          ...
          <p className="hp-bio">
            ...
            <span className="hp-bio__line">
              Hi, I'm Yakuzen (Dich), nice to work with you
            </span>
          </p>
        ...
        <div className="hp-works__header">
          <div className="hp-works__title-wrap">
            ...
            <h2 className="hp-works__title">
              <span className="title-stroke">RECENT</span>{" "}
              <span className="title-fill">WORKS</span>
            </h2>
          </div>
